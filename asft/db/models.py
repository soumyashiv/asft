...
class RoutingHistory(Base):
    ...
    strategy_selected: Mapped[str] = mapped_column(String, index=True) # e.g., 'lora', 'rag', 'skill'
    exploration_mode: Mapped[bool] = mapped_column(Boolean) # True if random explore, False if exploit
